...
// const {loadRoles, getPermissionsByRole, setRolesData } = require("./role_service")
...
//         // problem is loadRoles is not mocking correctly
...
//         const loadRolesSpy = roleService.loadRoles.mockReturnValue(dummyRoles);
//         console.log(loadRolesSpy.getMockName);
//         // const allRoles = ["admin"];
//         const result = roleService.getPermissionsByRole(["admin"]);
