...
export default function Library() {
  ...
  const handleSave = async () => {
    ...
    return (
        ...
        //                             <td style={mystyle}> <form action={`${urlDeleteBook}`} method="post"><button className="delete-button" name="book_id" value={`${book.book_id}`}>Delete</button></form></td>
        //                             <td style={mystyle}> <button name="book_id" value={`${book.book_id}`} type="button" onClick={() => handleEdit(book)}   >Edit</button></td>

        //                             {/* <td style={mystyle}> <form action={`${urlEditBook}`} method="post"><button id="book_id" name="book_id" value={`${book.book_id}`} onClick={()=>{
        //                         setEditable(true)
        //                     }}>Edit</button></form></td> */}
